...
SpurteConfig spurteConfigFromJson(String str) =>
    SpurteConfig.fromJson(json.decode(str));
...
class SpurteConfig {
  ...
  factory SpurteConfig.fromJson(Map<String, dynamic> json) =>
      _$SpurteConfigFromJson(json);
...
class SpurteDartBuildOptions {
  ...
  factory SpurteDartBuildOptions.fromJson(Map<String, dynamic> json) =>
      _$SpurteDartBuildOptionsFromJson(json);
...
class SpurteDevOptions {
  ...
  factory SpurteDevOptions.fromJson(Map<String, dynamic> json) =>
      _$SpurteDevOptionsFromJson(json);
...
class SpurteDartExperimentalOptions {
  ...
  factory SpurteDartExperimentalOptions.fromJson(Map<String, dynamic> json) =>
      _$SpurteDartExperimentalOptionsFromJson(json);
...
final spurteDartBuildTargetValues = EnumValues(
    {"js": SpurteDartBuildTarget.JS, "wasm": SpurteDartBuildTarget.WASM});
...
class SpurteDartWasmOptions {
  ...
  factory SpurteDartWasmOptions.fromJson(Map<String, dynamic> json) =>
      _$SpurteDartWasmOptionsFromJson(json);
...
class SpurteJsDartOptions {
  ...
  factory SpurteJsDartOptions.fromJson(Map<String, dynamic> json) =>
      _$SpurteJsDartOptionsFromJson(json);
...
class SpurteProdOptions {
  ...
  factory SpurteProdOptions.fromJson(Map<String, dynamic> json) =>
      _$SpurteProdOptionsFromJson(json);
...
class ProdHttps {
  ...
  factory ProdHttps.fromJson(Map<String, dynamic> json) =>
      _$ProdHttpsFromJson(json);
...
class SpurteServerOptions {
  ...
  factory SpurteServerOptions.fromJson(Map<String, dynamic> json) =>
      _$SpurteServerOptionsFromJson(json);
...
class ServerHttps {
  ...
  factory ServerHttps.fromJson(Map<String, dynamic> json) =>
      _$ServerHttpsFromJson(json);
